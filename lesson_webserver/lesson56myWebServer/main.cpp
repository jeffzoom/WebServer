...
// 视频5.6结束的完整代码
// 运行./a.out 10000之后，浏览器请求http://192.168.18.182:10000/，输出：读 process
...
#include "http_connt.h" // 这里有猫腻，能让straction解除提示不允许使用不完整的类型
#include "lockerp.h"
#include "threadpools.h"

// #define _XOPEN_SOURCE // 想让struct straction sa;不报错来着
...
int main(int argc, char *argv[]) { // 程序模拟的是proacter模式
    ...
    while (true) {
        ...
        // epoll_wait默认是阻塞的，产生信号就会中断，当epoll_wait中断结束返回，就会返回-1
